...
class Report:
    ...
    def _setup(self):
        ...
        r = header.add_run("สำนักการจราจรและขนส่ง  ·  รายงานการวิเคราะห์ปริมาณการจราจรทางแยกหลักสี่  ·  ตู้ 500")
    ...
    def cover(self):
        ...
        self.p("รายงานการวิเคราะห์ปริมาณการจราจรทางแยกหลักสี่", size=24, center=True, bold=True, space_after=4)
        self.p("(แยกไอทีสแควร์)", size=18, center=True, bold=True, space_after=10)
        self.p("ตามรูปแบบวิศวกรรมจราจร — ปริมาณจราจร แถวคอย ความจุ และแบบสัญญาณไฟจราจร", size=14, center=True, space_after=4)
        self.p("เพื่อวิเคราะห์การแก้ไขปัญหาจราจรในทางเลี้ยวซ้ายจากถนนแจ้งวัฒนะ เข้าถนนกำแพงเพชร 6 ทางทิศเหนือ", size=14, center=True, space_after=16)
        self.p("ถนนแจ้งวัฒนะ ตัด ถนนกำแพงเพชร 6", size=16, center=True, space_after=4)
        self.p("สัญญาณไฟจราจรหมายเลข 500  ·  รหัส N176", size=16, center=True, space_after=20)
        site = self.s["site"]
        meta = [
            ("ผู้วิเคราะห์ข้อมูลและจัดทำรายงาน", "นางสาวประภาวดี วชิรพุทธิ์  © Prapawadee_W."),
            ("ตำแหน่ง", "นักวิชาการสถิติชำนาญการ"),
            ("สังกัด", "กลุ่มงานสถิติและวิจัย  กองนโยบายและแผนงาน"),
            ...
            ("วิธีการศึกษา", "HCM 7  ·  Webster  ·  Harders  ·  ITE Recommended Practice"),
        ]
        ...
        self.p("นางสาวประภาวดี วชิรพุทธิ์", size=14, center=True, bold=True, space_after=2)
    ...
    def toc(self):
        ...
        items = [
            ...
            "บทที่ 3  วิธีการศึกษาและมาตรฐานตามหลักวิศวกรรมจราจร",
            "บทที่ 4  ผลการสำรวจและวิเคราะห์ข้อมูล",
            "บทที่ 5  แถวคอยและระดับการให้บริการปัจจุบัน",
            "บทที่ 6  วินิจฉัยปัญหา",
            "บทที่ 7  ทางเลือกการปรับปรุง",
            "บทที่ 8  การวิเคราะห์ผลจากการผายปากและปรับรัศมีวงเลี้ยว",
            "บทที่ 9  รูปแบบสัญญาณไฟจราจร บริเวณทางแยกหลักสี่",
            "บทที่ 10  ข้อเสนอแนะและข้อพิจารณาเพิ่มเติม",
    ...
    def ch1(self):
        ...
        self.p(
            "รายงานวิเคราะห์ฉบับก่อนใช้ทิศทาง NB เลี้ยวซ้าย และมีค่า PCU บางช่วงผิดปกติ "
            "รายงานฉบับนี้ใช้ทิศทางเป้าหมาย คือ EB5 (แจ้งวัฒนะขาเข้า เลี้ยวซ้ายเข้ากำแพงเพชร 6 ทิศเหนือ) "
            "และคำนวณใหม่จากแผ่น volume / Analysis / Queue ของไฟล์สำรวจดิบ"
        )
        self.h("1.2  วัตถุประสงค์การวิเคราะห์ข้อมูล", 2)
        for t in [
            "หาปริมาณจราจร องค์ประกอบรถ และแถวคอยของทิศทางเป้าหมายและทั้งแยก",
            "ประเมินระดับการให้บริการปัจจุบันของทิศทางเลี้ยวซ้ายตาม Highway Capacity Manual",
            "วิเคราะห์ผลจากการผายปากและเลี้ยวซ้ายผ่านตลอด เทียบสถานะสัญญาณไฟจราจร",
            "กำหนดแบบรอบสัญญาณไฟจราจรตามทิศทางการจราจรจริง",
            "เสนอผลจากมาตรการ พร้อมข้อเสนอแนะ",
        ]:
            self.p("•  " + t, space_after=4)
        self.h("1.3  ข้อจำกัดและขอบเขตการวิเคราะห์ข้อมูล", 2)
        self.p(
    ...
    def ch2(self):
        ...
        self.table(
            ["ทิศ", "ถนน / จุดสังเกต", "ทิศทาง Turning Movement"],
            [
        ...
        self.p(
            "ทิศเป้าหมาย: รถบนถนนแจ้งวัฒนะขาเข้า (ตะวันตก→ตะวันออก) เลี้ยวซ้ายเข้ากำแพงเพชร 6 ด้านทิศเหนือ "
            "รหัสนับในไฟล์ดิบคือ EB5"
        )
        self.picture(
            ROOT / "attachments/รูปผายปากแยกหลักสี่.png",
            caption="ภาพที่ 1  รูปแบบบริเวณที่จะทำการผายปาก — พื้นที่ขยายเขตทางประมาณ 153.00 ตร.ม. ระยะร่น Protection Zone A 3.00 ม.",
        )
    ...
    def ch3(self):
        self.h("บทที่ 3  วิธีการศึกษาและมาตรฐานตามหลักวิศวกรรมจราจร")
        self.p(
            "การวิเคราะห์ตามรายงานนี้ใช้หลัก ITE Recommended Practice (Transportation Impact Analyses) "
            "ปรับเป็นการศึกษาทางแยกเดี่ยว และใช้วิธีคำนวณตาม Highway Capacity Manual ฉบับที่ 7"
        )
        pcu = self.s["pcu"]
    ...
    def ch4(self):
        self.h("บทที่ 4  ผลการสำรวจและวิเคราะห์ข้อมูล")
        self.p(
        ...
        self.h("4.1  สรุปปริมาณจราจรทั้งแยกและทิศเป้าหมาย", 2)
        self.table(
        ...
        self.h("4.2  ปริมาณจราจรรายขาเข้า 12 ชั่วโมง", 2)
        ...
        self.caption("ที่มา: รวมจากแผ่น Report / Analysis — แถว EB5 คือทิศเป้าหมายของโครงการ")
        self.h("4.4  สัดส่วนรถในทิศทาง EB5", 2)
        mix = self.s["mixEb5"]
        ...
        self.p(
            ...
            "ข้อเสนอแนะ: รัศมีวงเลี้ยวต้องกว้างเพียงพอสำหรับรถใหญ่ที่อาจมีปริมาณ 14 คันต่อวัน"
        )
    ...
    def ch5(self):
        self.h("บทที่ 5  แถวคอยและระดับการให้บริการปัจจุบัน")
    ...
    def ch8(self):
        self.h("บทที่ 8  การวิเคราะห์ผลจากการผายปากและปรับรัศมีวงเลี้ยว")
        d_geom, cap_geom, x_geom = self.geom
        ...
        self.p(
            ...
            f"ปริมาณจราจรขัดแย้งใช้ขา NB ชั่วโมง 12:00–13:00 จากไฟล์ดิบ = {th(self.conflict)} คัน/ชม."
        )
        self.table(
    ...
    def ch9(self):
        self.h("บทที่ 9  รูปแบบสัญญาณไฟจราจร บริเวณทางแยกหลักสี่ (แยกไอทีสแควร์)")
        self.p(
    ...
    def ch10(self):
        self.h("บทที่ 10  ข้อเสนอแนะและข้อพิจารณาเพิ่มเติมด้านวิศวกรรมจราจร")
        ...
        self.h("10.1  สรุปผลการวิเคราะห์", 2)
        self.p(
            f"ปริมาณจราจรช่วงเร่งด่วนเช้า 07:00–09:00 น. ในทิศทาง EB5 รวม {th(am)} คัน "
            f"(เฉลี่ย {th(am / 2)} คัน/ชม.) ช่วงเร่งด่วนเย็น 16:00–18:00 น. รวม {th(pm)} คัน "
            f"ช่วงพีคของทิศทางนี้คือ 12:00–13:00 น. ที่ {th(self.demand)} คัน/ชม."
        )
        self.p(
            f"ปริมาณจราจรที่ใช้ทิศทาง EB5 รวม 12 ชั่วโมง จำนวน {th(self.s['eb5_12h'])} คัน "
        ...
        self.p(
            f"การผายปากและปรับเลี้ยวซ้ายผ่านตลอดสามารถดึงรถเลี้ยวซ้ายออกจากสัญญาณไฟ 15–20% ของขา EB "
            f"ซึ่งเป็นขาที่ความยาวแถวคอยยาวที่สุด (สูงสุด 200 ม.) ค่า v/c ประมาณ {free_x:.2f} LOS {los_un(free_d)} "
            f"ลดการหน่วงจากประมาณ {th(d_geom)} วินาที เหลือ {th(free_d)} วินาทีต่อคัน"
        )
        self.h("10.2  ข้อพิจารณาเพิ่มเติมด้านวิศวกรรมจราจร", 2)
        for i, t in enumerate(
            [
                "ช่องเร่งความเร็ว (Acceleration Lane) บนถนนกำแพงเพชร 6 (ทิศเหนือ) ควรกำหนดความยาวอย่างน้อย 40–60 เมตร (หากเขตทางเพียงพอ) เพื่อลดการแย่งช่องจราจรของรถเลี้ยวซ้ายผ่านตลอดกับรถทางตรงที่รอจังหวะสัญญาณไฟจราจร",
                "ความยาวช่องทางเข้าและระยะปาด (Entry Lane and Taper) กำหนดในระยะ 26 เมตร สำหรับการรองรับคิวรถรอให้ทาง (Yield) ประมาณ 2–4 คัน เนื่องจากความจุของถนนในสภาวะที่รถเคลื่อนตัวได้อิสระ (Free-flow) มีปริมาณความต้องการมากกว่า 342 คัน/ชั่วโมง",
                "ติดตั้งป้ายและเครื่องหมายจราจรเพิ่มเติม อาทิ เครื่องหมายเลี้ยวซ้ายผ่านตลอด ป้ายเตือนให้ทาง (Yield Sign) และเครื่องหมายห้ามจอดรถบริเวณทางแยก",
                "ปรับเลื่อนตำแหน่งทางข้าม (ทางม้าลาย) ให้พ้นจากรัศมีทางโค้ง หรือออกแบบให้มีเกาะหลบภัย (Refuge Island) เพื่อลดความเสี่ยงในการเกิดอุบัติเหตุจากรถเลี้ยวซ้ายผ่านตลอด",
                "ตรวจสอบรัศมีวงเลี้ยว (Swept Path) เนื่องจากทิศทางดังกล่าวอาจมีปริมาณรถบรรทุกและรถโดยสารขนาดใหญ่จำนวน 14 คัน/12 ชั่วโมง จึงต้องตรวจสอบรัศมีวงเลี้ยวจากแบบก่อสร้าง (มาตราส่วน 1:500) ให้ถี่ถ้วนก่อนดำเนินการก่อสร้างจริง",
        ...
        self.h("10.3  ลำดับงาน", 2)
        for i, t in enumerate(
            [
                "การรถไฟฟ้าขนส่งมวลชนแห่งประเทศไทยยืนยันเขต Protection Zone A ก่อนก่อสร้าง",
                "สำนักการโยธาตรวจสอบรัศมีวงเลี้ยวและช่องเร่งความเร็วทิศเหนือ",
                "สำนักการจราจรและขนส่งลงโปรแกรมตู้ตามบทที่ 9 (หัวลูกศรที่ B/D ตารางขัดแย้ง intergreen และ OFFSET)",
                "เปิดช่องเลี้ยวซ้ายผ่านตลอดพร้อมป้ายให้ทาง หลังงานโยธาและหัวสัญญาณเสร็จ",
                "สำรวจหลังเปิดใช้ 15 นาที × 1 วันทำการ เพื่อเทียบความยาวแถวคอยขา EB กับฐาน 200 เมตร",
            ],
            1,
        ):
            self.p(f"{i}.  {t}", space_after=4)
        self.h("10.4  รายการตรวจก่อนติดตั้งสัญญาณไฟจราจร", 2)
        checks = [
        ...
        self.h("ผู้วิเคราะห์ข้อมูลและจัดทำรายงาน", 2)
        self.p("นางสาวประภาวดี วชิรพุทธิ์", bold=True)
        self.p("นักวิชาการสถิติชำนาญการ")
        self.p("กลุ่มงานสถิติและวิจัย กองนโยบายและแผนงาน")
        self.p("สำนักการจราจรและขนส่ง กรุงเทพมหานคร")
    ...
    def ch12(self):
        ...
        refs = [
            ...
            "รูปแบบบริเวณที่จะทำการผายปาก แยกหลักสี่ (แบบขอใช้พื้นที่ ที่แนบ).",
        ]
