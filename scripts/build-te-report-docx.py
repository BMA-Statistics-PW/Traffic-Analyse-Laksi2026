...
class Report:
    ...
    def ch10(self):
        ...
        for i, t in enumerate(
            [
                "ช่องเร่งความเร็ว (Acceleration Lane) บนถนนกำแพงเพชร 6 ทิศเหนือ ควรกำหนดความยาวอย่างน้อย 40–60 เมตร หากเขตทางเพียงพอ",
                "ความยาวช่องทางเข้าและระยะปาด (Entry Lane and Taper) กำหนดในระยะ 26 เมตร สำหรับรองรับคิวรถรอให้ทางประมาณ 2–4 คัน",
                "ติดตั้งป้ายและเครื่องหมายจราจรเพิ่มเติม ได้แก่ เครื่องหมายเลี้ยวซ้ายผ่านตลอด ป้ายเตือนให้ทาง และเครื่องหมายห้ามจอดรถบริเวณทางแยก",
                "ปรับเลื่อนตำแหน่งทางข้ามให้พ้นจากรัศมีทางโค้ง หรือออกแบบให้มีเกาะหลบภัย (Refuge Island)",
                "ตรวจสอบรัศมีวงเลี้ยว (Swept Path) ของรถบรรทุกและรถโดยสารขนาดใหญ่จำนวน 14 คันต่อ 12 ชั่วโมง จากแบบก่อสร้างมาตราส่วน 1:500",
