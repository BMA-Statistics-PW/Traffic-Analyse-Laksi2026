...
class Report:
    ...
    def toc(self):
        ...
        items = [
            ...
            "บทที่ 10  ข้อเสนอแนะและแผนดำเนินงาน",
    ...
    def ch8(self):
        ...
        self.h("8.1  ข้อพิจารณาเพิ่มเติมด้านวิศวกรรมจราจร", 2)
        for i, t in enumerate(
            [
                ...
                "ความยาวช่องทางเข้าและระยะปาด (Entry Lane and Taper) กำหนดในระยะ 26 เมตร สำหรับการรองรับคิวรถรอให้ทาง (Yield) ประมาณ 2–4 คัน เนื่องจากความจุของถนนในสภาวะที่รถเคลื่อนตัวได้อิสระ (Free-flow) สูงกว่าปริมาณความต้องการ 342 คัน/ชั่วโมง",
                ...
                "ตรวจสอบรัศมีวงเลี้ยว (Swept Path) เนื่องจากทิศทางดังกล่าว อาจมีปริมาณรถบรรทุกและรถโดยสารขนาดใหญ่จำนวน 14 คัน/12 ชั่วโมง จึงต้องตรวจสอบรัศมีวงเลี้ยวจากแบบก่อสร้าง (มาตราส่วน 1:500) ให้ถี่ถ้วนก่อนดำเนินการก่อสร้างจริง",
    ...
    def ch10(self):
        self.h("บทที่ 10  ข้อเสนอแนะและแผนดำเนินงาน")
        ...
        for i, t in enumerate(
            ...
            self.p(f"{i}.  {t}", space_after=4)
        self.h("10.3  รายการตรวจก่อนติดตั้งสัญญาณไฟจราจร", 2)
        checks = [
