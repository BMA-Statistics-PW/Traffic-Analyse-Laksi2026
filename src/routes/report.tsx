    ...
    <Shell>
      ...
      <section className="mt-6 rounded-[18px] bg-surface p-5 shadow-card sm:p-6">
        ...
        <ol className="mt-3 list-decimal space-y-3 pl-5 text-sm leading-relaxed">
          <li>
            <strong>ดำเนินการผายปากตามแบบที่เสนอ</strong> — ปริมาณจราจร {n(survey.eb5_12h)} คัน/12 ชม. ไม่ใช่ทิศทางเล็ก
            และความยาวแถวคอยขาเข้าถนนแจ้งวัฒนะเป็นปัญหาหลักของแยก
          </li>
          <li>
            <strong>จัดช่องเลี้ยวซ้ายผ่านตลอดพร้อมเกาะสามเหลี่ยม</strong> ตามแบบ โดยร่นเขตทางสายสีชมพู 3.00 เมตร ห้ามล้ำ
          </li>
          <li>
            <strong>เพิ่มช่องเร่งความเร็วบนถนนกำแพงเพชร 6 ทิศเหนือ 40–60 เมตร</strong> หากเขตทางเพียงพอ เพื่อลดความขัดแย้งตอนรวมช่อง
          </li>
          <li>
            <strong>ปรับรอบจังหวะสัญญาณไฟจราจรหลังเปิดใช้</strong> ลดหรือยกเฟสเลี้ยวซ้าย EB แล้วคืนเวลาเขียวให้ทางตรงถนนแจ้งวัฒนะ
            ซึ่งจะช่วยความยาวแถวคอย 114–200 เมตร ได้มากกว่าตัวเลขเลี้ยวซ้ายอย่างเดียว
          </li>
          <li>
            <strong>ปรับเลื่อนตำแหน่งทางข้าม</strong> ให้พ้นจากรัศมีทางโค้ง หรือออกแบบให้มีเกาะหลบภัย
          </li>
          <li>
            <strong>ตรวจสอบรัศมีวงเลี้ยว (Swept Path)</strong> ของรถโดยสารและรถบรรทุก (14 คันต่อ 12 ชั่วโมงในทิศทางนี้) ก่อนก่อสร้าง
          </li>
          <li>
            <strong>เก็บข้อมูลหลังเปิดใช้ 14 วัน</strong> ได้แก่ ปริมาณจราจร ความยาวแถวคอย ความเร็ว และจุดตัดคนเดิน เทียบกับฐานสำรวจ 20 พฤษภาคม 2569
          </li>
        </ol>
      </section>
