    ...
    <Shell>
      ...
      <article className="doc-paper space-y-10 rounded-[18px] bg-surface p-5 shadow-card sm:p-8">
        ...
        <section id="ch8" className="doc-break space-y-3">
          ...
          <h4 className="font-semibold">8.1 เงื่อนไขออกแบบประกอบ</h4>
          <ul className="list-disc space-y-1 pl-5">
            <li>ช่องเร่งบนกำแพงเพชร 6 เหนือ 40–60 ม. หากเขตทางพอ</li>
            <li>ป้ายให้ทาง + ลูกศรซ้ายผ่านตลอด + ห้ามจอดปากทาง</li>
            <li>ย้ายทางม้าลายพ้นปากโค้ง หรือเกาะหลบภัย — ซ้ายอิสระตัดคนข้ามมากขึ้น</li>
            <li>ตรวจ swept path รถเมล์/บรรทุกจากแบบ 1:500 ก่อนก่อสร้าง</li>
            <li>ห้ามล้ำ Protection Zone A 3.00 ม.</li>
          </ul>
        </section>
